...
export const GROWTH_TAXONOMY = [
  ...
  ["athletics", /\b(grappl(?:e|es|ed|ing)|shov(?:e|es|ed|ing)|lift(?:s|ed|ing)?|sw(?:am|im|ims|imming)|force[ds]?\b[^.!?]{0,20}\bopen\b|carr(?:y|ies|ied|ying)|haul(?:s|ed|ing)?|heav(?:e|es|ed|ing)|dragg(?:ed|ing)|drags\b|wrestl(?:e|es|ed|ing)|held (?:the )?(?:door|gate|weight)|tripp(?:ed|ing)|trips\b)\b/i],
...
const INTENT_ONLY_PATTERN =
  /\b(want(?:ed|s)? to|plan(?:ned|s)? to|mean(?:t|s) to|hop(?:ed|es) to|intend(?:ed|s)? to|(?:was|were) going to|thought about \w+ing|considered \w+ing|debated whether|argued about whether|wished (?:he|she|they) could)\b/i;
